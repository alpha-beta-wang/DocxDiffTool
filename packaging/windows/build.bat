...
echo [arm64 3/3] Building installer...
if exist "%ISCC%" (
    "%ISCC%" "%~dp0setup-arm64.iss"
) else (
    echo WARNING: Inno Setup not found, skipping installer
)
...
echo   arm64 Installer: dist\installer\windows\DocxDiffTool_arm64_Setup.exe
